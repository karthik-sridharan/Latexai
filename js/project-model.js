...
\begin{abstract}
This Stage 1E keeps the Chuvadi provider foundation and adds a real backend compile runner with TeX Live, isolated temporary workspaces, backend health checks, status polling, structured logs, and click-to-line diagnostics.
\end{abstract}
...
`;
  ...
  function defaultSettings() {
    return {
      ...
      compileUrl: 'https://lumina-latex-backend-zugntkn2la-ue.a.run.app/api/lumina/latex/compile',
      compileStatusUrl: 'https://lumina-latex-backend-zugntkn2la-ue.a.run.app/api/lumina/latex/compile/jobs',
      backendStatusUrl: 'https://lumina-latex-backend-zugntkn2la-ue.a.run.app/api/lumina/latex/status',
      useCompileJobs: false,
      compileJobsUserEnabled: false,
      compilePollMs: 1000,
