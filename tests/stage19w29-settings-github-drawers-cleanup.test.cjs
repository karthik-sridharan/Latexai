...
assert(index.includes('stage19w29-settings-github-drawers-cleanup-20260605-1'), 'index should cache-bust changed stage 19W29 files');
...
console.log('stage19w29 settings GitHub drawers cleanup checks passed');
